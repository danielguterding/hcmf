...
def main():
  outfilename = 'result_meanfieldmodel_Y3Cu9OH19Cl8_9spin_cluster2.dat'
  modelfilename = 'examples/meanfieldmodel_Y3Cu9OH19Cl8_9spin_cluster2.dat'
  magneticpatterns = get_patterns_honeycomb()
  calc = HeisenbergMeanFieldCalculator()
  calc.read_modelfile(modelfilename)
  J2vals = np.linspace(0.0,0.51,num=5,endpoint=True)
  B = 0.0
  results = []
  for J2 in J2vals:
    res_this_J2 = []
