...
def get_patterns():
  patterns = []
  patterns.append(MagneticOrder('zAFM', [0.5, -0.5, 0.5, -0.5, 0.5, -0.5]))
...
def main():
  outfilename = 'results_kagome_interlayer_x3z2.dat'
  modelfilename = 'examples/meanfieldmodel_kagome_interlayer_x3z2.dat'
  spinbasisfilename = 'spinbasis_kagome_interlayer_x3z2.dat'
  hamiltonianfilename = 'hamiltonian_kagome_interlayer_x3z2.dat'
  ...
  J2vals = np.linspace(0.1,0.5,num=14,endpoint=True)
  B = 0.0
  results = []
  for J2 in J2vals:
    res_this_J2 = []
