...
def get_patterns_honeycomb():
  patterns = []
  patterns.append(MagneticOrder('Neel', [0.5, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.5]))
  patterns.append(MagneticOrder('PM', [0, 0, 0, 0, 0, 0, 0, 0]))
  patterns.append(MagneticOrder('Stripe', [-0.5, -0.5, -0.5, -0.5, 0.5, 0.5, 0.5, 0.5]))
  return patterns
...
def main():
  outfilename = 'honeycomb_J1_J2_fourdimer.dat'
  modelfilename = 'examples/meanfieldmodel_honeycomb_fourdimer.dat'
